...
import 'package:fwc_album_app/app/core/exceptions/repository_exceprion.dart';
...
class AuthRepossitoryImpl implements AuthRepository {
  final CustomDio dio;

  AuthRepossitoryImpl({required this.dio});
